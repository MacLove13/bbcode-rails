...
describe BBCode do
  ...
  it 'correctly parses the Code tag' do
    ...
    expect(BBCode.parse "[code]asdasd[b]oi[/b][/code]").to eq "<p><div class=\"code-container\"><pre><code class=\"code-block\">asdasd[b]oi[/b]</code></pre><button class=\"copy-button\">Copy</button></div></p>"
  end
